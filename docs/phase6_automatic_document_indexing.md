...
| `scripts/evaluate_phase6_automatic_indexing.py` | mini-evaluation |
| `docs/phase6_automatic_document_indexing.md` | this report |
...
Artifact: `artifacts/phase6_automatic_document_indexing_evaluation.json`.
...
| `phase13_openapi.json` | regenerated by its own test, as on every run; now carries the new form fields and response fields |
| `phase6_automatic_document_indexing_evaluation.json` | **new** |
...
*See also: [Phase 5 — Representation Content Resolution](phase5_representation_content_resolution.md),
