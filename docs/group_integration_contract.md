...
**Snapshot:** `artifacts/openapi_contract_snapshot.json`
...
- OpenAPI **3.1.0**, service version `1.0`, **24 operations**.
- Snapshot: `artifacts/openapi_contract_snapshot.json`, generated by its own test.
...
Deterministic harness: `scripts/evaluate_integration_contract.py`.
