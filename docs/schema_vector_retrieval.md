...
| `scripts/evaluate_schema_retrieval.py` | mini-evaluation |
...
| `docs/schema_vector_retrieval.md` | this report |
...
Artifact: `artifacts/schema_retrieval_evaluation.json`.
...
| `openapi_contract_snapshot.json` | regenerated by its own test, as on every run |
| `schema_retrieval_evaluation.json` | **new** |
...
*See also: [Phase 6 — Automatic Document Indexing](automatic_document_indexing.md),
