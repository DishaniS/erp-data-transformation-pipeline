...
ERROR_STATUS: Mapping[type, int] = {
    ...
    RepresentationNotFoundError: 404,
    JobNotFoundError: 404,
    UploadNotFoundError: 404,
    JobConflictError: 409,
    MappingNotExecutableError: 409,
    # A conflict, not a bad request: the job is well-formed, but this entity
    # already belongs to the canonical path and cannot be indexed around it.
    SourceNativeNotPermittedError: 409,
